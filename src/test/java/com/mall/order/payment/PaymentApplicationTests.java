...
//    }
    ...
    @Test
    public void getPrepaidOrder()throws Exception {
//userCode=2019031915051114485&orderStatus=0&orderTime=
        mockMvc.perform(MockMvcRequestBuilders.get("/chargeItem/getOrder")
                .param("userCode","2019031915051114485")
                .param("orderStatus","0")
                .accept(MediaType.APPLICATION_JSON_UTF8))
                .andDo(MockMvcResultHandlers.print())
                .andReturn();
